  ...
  return (
    ...
    <header className="sticky top-0 bg-white shadow-sm z-50">
      <nav className="max-w-6xl mx-auto px-4 py-5 flex justify-between items-center">
        ...
        <a href="#home" id="logo" className="text-xl font-semibold text-slate-900 hover:text-blue-600 transition">
          Janani
        </a>
        ...
        <div id="desktop-menu" className="hidden md:flex gap-8">
          {navLinks.map((link) => (
            <a
              ...
              // "transition" => smooth animation when colors change
        ...
        <button
          id="menu-button"
          className="md:hidden p-2 text-slate-700 hover:text-blue-600 transition text-xl"
            ...
            <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col gap-2">
              {navLinks.map((link) => (
                <a
                  ...
                  className="block py-2 px-3 text-slate-700 hover:text-blue-600 hover:bg-blue-50 rounded transition font-medium"
